...
public class AppTest {
	...
	public void test1() {
		...
		try {
			operationClass = Class.forName("com.qualizeal.javaapp04.operation.TwoNonDecimalNumbersMultiplication");
	...
	public void test2() {
		...
		try {
			...
			String expectedMethodSyntax = "public long com.qualizeal.javaapp04.operation.TwoNonDecimalNumbersMultiplication.multiply(int,int)";
